...
public class BattleEquip_PossessItem : MonoBehaviour
{
	[SerializeField]
	...
	[SerializeField]
	private UIEffectSort effectSort;
	...
	private Callback<BattleEquip_PossessItem> onClickItem;

	public Callback<BattleEquip_PossessItem> OnClickItem
	{
		get
		{
	...
	public GameObject RootGoObj
	{
		get
		{
			return this.rootGoObj;
		}
		set
		{
			this.rootGoObj = value;
			this.SetEffectParam();
		}
	}
	...
	{
		this.PlayNewItemAnimator(false);
	}
	...
	{
		BattleEquip_PossessItem.<ReSetScale>c__IteratorF9 <ReSetScale>c__IteratorF = new BattleEquip_PossessItem.<ReSetScale>c__IteratorF9();
	...
	public void PlayNewItemAnimator(bool b = true)
	{
		if (b && this.effectSort.gameObject.activeSelf)
		{
			this.effectSort.gameObject.SetActive(false);
		}
		this.effectSort.gameObject.SetActive(b);
	}
	...
	private void SetEffectParam()
	{
		...
		{
			this.effectSort.panel = this.RootGoObj.GetComponent<UIPanel>();
			this.effectSort.UpdateSortUI();
		}
	}
}
