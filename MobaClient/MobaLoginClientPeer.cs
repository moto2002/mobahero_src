...
{
	public class MobaLoginClientPeer : MobaPeer, IPhotonPeerListener
	{
		private StatusCode _lastStatusCode;

		public MobaLoginClientPeer(ConnectionProtocol protocolType, PhotonClient client) : base(protocolType, client, MobaPeerType.C2Master)
		{
			this.mClient = client;
			base.Listener = this;
		}
