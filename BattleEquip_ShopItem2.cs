...
public class BattleEquip_ShopItem2 : MonoBehaviour
{
	[SerializeField]
	private UISprite B_Mask;

	[SerializeField]
	private UISprite_shader B_Texture;
	...
	private void RefreshUI_item()
	{
		if (this.ItemData != null)
		{
			...
			this.B_Texture.spriteName = this.ItemData.Config.icon;
	...
	private void RefreshUI_affordState()
	{
		...
		if (flag)
		{
			this.B_Texture.SetNormal();
		}
		else
		{
			this.B_Texture.SetGray();
		}
	}
	...
	{
		BattleEquip_ShopItem2.<ReSetScale>c__IteratorFB <ReSetScale>c__IteratorFB = new BattleEquip_ShopItem2.<ReSetScale>c__IteratorFB();
		<ReSetScale>c__IteratorFB.tra = tra;
		<ReSetScale>c__IteratorFB.<$>tra = tra;
		return <ReSetScale>c__IteratorFB;
	}
}
