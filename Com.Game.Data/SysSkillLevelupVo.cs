...
{
	[Serializable]
	public class SysSkillLevelupVo
	{
		public string unikey;

		public string skill_id;

		public int NewSkill_id;

		public int NewSkill_Level;
		...
		public int is_autoattackseltarget_onskillend;

		public string SkillExtraParam;

		public string ConjureRangetype;
	}
}
