...
public class AkSoundEngine
{
	...
	{
		return AkSoundEngine.RegisteredGameObjects.Contains(in_gameObject.GetInstanceID());
	}
	...
	public static AKRESULT RegisterGameObj(GameObject in_gameObjectID)
	{
		...
		AKRESULT aKRESULT = AkSoundEngine.RegisterGameObjInternal(in_gameObjectID.GetInstanceID());
		if (aKRESULT == AKRESULT.AK_Success)
		{
			AkSoundEngine.RegisteredGameObjects.Add(in_gameObjectID.GetInstanceID());
		}
		return aKRESULT;
	}
	...
	public static AKRESULT RegisterGameObj(GameObject in_gameObjectID, uint in_uListenerMask)
	{
		...
		AKRESULT aKRESULT = AkSoundEngine.RegisterGameObjInternal_WithMask(in_gameObjectID.GetInstanceID(), in_uListenerMask);
		if (aKRESULT == AKRESULT.AK_Success)
		{
			AkSoundEngine.RegisteredGameObjects.Add(in_gameObjectID.GetInstanceID());
		}
	...
	public static AKRESULT RegisterGameObj(GameObject in_gameObjectID, string in_pszObjName)
	{
		...
		AKRESULT aKRESULT = AkSoundEngine.RegisterGameObjInternal_WithName(in_gameObjectID.GetInstanceID(), in_gameObjectID.name);
		if (aKRESULT == AKRESULT.AK_Success)
		{
			AkSoundEngine.RegisteredGameObjects.Add(in_gameObjectID.GetInstanceID());
		}
	...
	public static AKRESULT RegisterGameObj(GameObject in_gameObjectID, string in_pszObjName, uint in_uListenerMask)
	{
		...
		AKRESULT aKRESULT = AkSoundEngine.RegisterGameObjInternal_WithName_WithMask(in_gameObjectID.GetInstanceID(), in_gameObjectID.name, in_uListenerMask);
		if (aKRESULT == AKRESULT.AK_Success)
		{
			AkSoundEngine.RegisteredGameObjects.Add(in_gameObjectID.GetInstanceID());
		}
	...
	public static AKRESULT UnregisterGameObj(GameObject in_gameObjectID)
	{
		...
		AKRESULT aKRESULT = AkSoundEngine.UnregisterGameObjInternal(in_gameObjectID.GetInstanceID());
		if (aKRESULT == AKRESULT.AK_Success)
		{
			AkSoundEngine.RegisteredGameObjects.Remove(in_gameObjectID.GetInstanceID());
		}
		return aKRESULT;
	}
	...
	private static int AutoRegisterAkGameObj(GameObject in_gameObject, ref AkAutoObject autoObject)
	{
		...
		if (in_gameObject != null)
		{
			...
			if (!AkSoundEngine.IsAkGameObjectRegistered(in_gameObject))
			{
	...
	{
		AkAutoObject akAutoObject = null;
		uint jarg = (uint)AkSoundEngine.AutoRegisterAkGameObj(in_gameObjectID, ref akAutoObject);
	...
	{
		if (!AkSoundEngine.IsAkGameObjectRegistered(in_gameObjectID))
		{
			return;
		}
		AkAutoObject akAutoObject = null;
	...
	{
		AkAutoObject akAutoObject = null;
		uint jarg = (uint)AkSoundEngine.AutoRegisterAkGameObj(in_ObjectID, ref akAutoObject);
	...
	{
		AkAutoObject akAutoObject = null;
		uint jarg = (uint)AkSoundEngine.AutoRegisterAkGameObj(in_GameObj, ref akAutoObject);
	...
	{
		AkAutoObject akAutoObject = null;
		uint jarg = (uint)AkSoundEngine.AutoRegisterAkGameObj(in_GameObjId, ref akAutoObject);
