...
public class Moba_Camera_Boundaries
{
	...
	private static List<Moba_Camera_Boundary> cube_boundaries = new List<Moba_Camera_Boundary>();

	private static List<Moba_Camera_Boundary> sphere_boundaries = new List<Moba_Camera_Boundary>();
	...
	public static void SetBoundaryLayerExist(bool value)
	{
		if (Moba_Camera_Boundaries.boundaryLayerExists)
		{
			...
			Debug.LogWarning("LayerMask not set for Moba_Camera_Boundaries. Add new Layer named " + Moba_Camera_Boundaries.boundaryLayer + ". Check Read me for more information on recommended settings.");
		}
	}
